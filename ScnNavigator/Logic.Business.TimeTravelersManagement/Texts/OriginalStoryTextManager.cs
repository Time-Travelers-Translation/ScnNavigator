...
{
    internal class OriginalStoryTextManager : StoryTextManager, IOriginalStoryTextManager
    {
        private readonly IBasePathProvider _basePathProvider;

        public OriginalStoryTextManager(IPckReader pckReader, IConfigurationReader<RawConfigurationEntry> configReader, 
        ...
        protected override string GetFullPath(string resourcePath)
            => _basePathProvider.GetFullPath(resourcePath, AssetPreference.Original);
    }
}
