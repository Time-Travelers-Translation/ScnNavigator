...
using Logic.Business.RenderingManagement;
...
using Logic.Domain.GraphVizManagement;
...
using UI.ScnNavigator.Components;
using UI.ScnNavigator.Dialogs;
using UI.ScnNavigator.Forms;
using UI.ScnNavigator.Resources;

namespace Mappings.ScnNavigator
{
    public class KernelInitializer : IKernelInitializer
    {
        ...
        {
            kernel.RegisterComponent<ScnNavigatorFormsActivator>();
            kernel.RegisterComponent<ScnNavigatorDialogsActivator>();
            kernel.RegisterComponent<ScnNavigatorComponentsActivator>();
            kernel.RegisterComponent<ScnNavigatorResourcesActivator>();

            kernel.RegisterComponent<RenderingManagementActivator>();
            ...
            kernel.RegisterComponent<GraphVizManagementActivator>();
