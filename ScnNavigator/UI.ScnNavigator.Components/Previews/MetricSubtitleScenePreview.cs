...
{
    internal class MetricSubtitleScenePreview : ScenePreview
    {
        private SubtitleMetricData? _metricData;
        private bool _showWarnings;

        public MetricSubtitleScenePreview(ITextRendererProvider rendererProvider, IScreenResourceProvider screenProvider,
            ...
            : base(rendererProvider, screenProvider, characterReplacer, eventBroker, textNormalizer)
        {
            ...
            eventBroker.Subscribe<MetricPreviewChangedMessage<SubtitleMetricData>>(ChangeMetricDetails);
        }
        ...
        private void ChangeMetricDetails(MetricPreviewChangedMessage<SubtitleMetricData> message)
        {
