...
{
    internal partial class OutlinesForm
    {
        ...
        private void InitializeComponent(OutlinePreviewData data, IPreviewComponentFactory previewFactory, IEventBroker eventBroker)
        {
            _previewForm = previewFactory.CreateOutlinePreview();
            eventBroker.Raise(new PreviewChangedMessage<OutlinePreviewData>(_previewForm, data, 0));
