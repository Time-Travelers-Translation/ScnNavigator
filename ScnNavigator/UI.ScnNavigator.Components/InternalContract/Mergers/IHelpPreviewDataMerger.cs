...
namespace UI.ScnNavigator.Components.InternalContract.Mergers
{
    ...
    public interface IHelpPreviewDataMerger
    {
        HelpPreviewData Merge(string originalTitle, EventText[] originalTexts, TextData? translatedTitle, TextData[]? translatedTexts);
    }
}
